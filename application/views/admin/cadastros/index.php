        ...
        <div class="animated fadeIn">
            <div class="card">
                <div class="card-header">
                    <i class="fa fa-align-justify"></i> Cadastros
                    <a class="pull-right btn btn-warning btn-large" style="color: white; float: right;" href="<?=site_url("cadastros/exportCSV")?>">
                ...
                <table class="table table-responsive-sm text-center">
                    ...
                    <? foreach ($cadastros as $cadastro) { ?>
                        <tr>
                            ...
                            <td><?=date('d/m/Y H:i', strtotime($cadastro->DataCadastro))?></td>
                        </tr>
                    <? } ?>
                    </tbody>
                </table>
